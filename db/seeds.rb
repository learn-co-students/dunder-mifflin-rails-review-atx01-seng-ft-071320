...
Dog.create(name: "Rufus", breed: "Sheepdog", age: "2")
Dog.create(name: "Bingo", breed: "Bulldog", age: "7")
Dog.create(name: "Ollie", breed: "Rottweiler", age: "6")
Dog.create(name: "Smoosh", breed: "Terrier", age: "5")
Dog.create(name: "Derp", breed: "Setter", age: "3")
